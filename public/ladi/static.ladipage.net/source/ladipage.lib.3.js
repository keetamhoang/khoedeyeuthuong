...
var checkForm = {countForm: 0, countTo: 0, value: "false"}, leftchange = 1, widthWindow = $(window).outerWidth(),
...
var resetLink = function () {
    ...
    if ($(t) && $(t).length > 0 && "phone" == $(t).attr("name")) {
        ...
        if ($(".formHintBubble").remove(), 10 == i.length || 11 == i.length)if (10 == (i = i.replace(/[^0-9]/g, "")).length || 11 == i.length); else {
            var n = $(t).parent().parent(), o = parseFloat($(t).parent().css("top")) - 35,
                a = $("<span/>").html('<span class="formHintBubble" style="top: ' + o + 'px;">Không phải số điện thoại</span>').contents();
            n.append(a), $(t).val(i), e = !1
        } else {
            n = $(t).parent().parent(), o = parseFloat($(t).parent().css("top")) - 35, a = $("<span/>").html('<span class="formHintBubble" style="top: ' + o + 'px;">Không phải số điện thoại</span>').contents();
            n.append(a), $(t).val(i), e = !1
        }
    }
    return e
    ...
    if (t && t.length > 0) {
        ...
        switch (e) {
            ...
            case"page":
                ...
                break;
            case"url":
                n.setAttribute("href", i), n.setAttribute("target", o), n.style.display = "none", n.click(), document.body.removeChild(n);
                break;
            case"popup":
                var r = $("#" + i);
    ...
    var i = "";
    i = t && t.length > 0 ? t : "Chưa gửi được thông tin, vui lòng liên hệ trực tiếp với chúng tôi!";
    var n = $("#" + e);
    if (n && n.attr("lp-id-pop-sub") && n.attr("lp-id-pop-sub").length > 0) {
        ...
        o.find(".container").find(".closePop").remove(), o.find(".container").find(".iframeTks").remove(), o.find(".container").eq(0).append('<div class="closePop" style="top:-25px; right:0;">X</div>'), o.removeClass("lp-hidepopup"), o.addClass("lp-showpopup"), o.css({
            display: "block",
            position: "fixed"
        ...
        if (n.attr("lp-ss-f") && n.attr("lp-ss-f").length > 0) {
            var r = getUtm("utm_source"), l = getUtm("utm_medium"), s = getUtm("utm_campaign"), c = getUtm("utm_term"),
                p = getUtm("utm_content");
            r && r.length > 0 && (a += "&utm_source=" + r), l && l.length > 0 && (a += "&utm_medium=" + l), s && s.length > 0 && (a += "&utm_campaign=" + s), c && c.length > 0 && (a += "&utm_term=" + c), p && p.length > 0 && (a += "&utm_content=" + p);
            n.find(".widget-element .widget-content");
            if (a && a.length > 0) {
                var d = "?", h = n.attr("lp-id-pop-url").split("/");
                "?" == h[h.length - 1][0] && (d = "&"), a && a.length > 0 && (a = d + a.slice(1, a.length))
            }
        }
        var u = n.attr("lp-id-pop-url") + a;
        window.location.href = u
    } else {
        $(".popup.ladi-popup-form").hide(), $('.widget-section[lp-popup="true"]').hide();
        var g = "";
        g += '<div class="popup ladi-popup-form" data-form="' + e + '" style="display:none;"> <div class="popup-dialog bounceIn animated" style="display: none;"> <div class="popup-header">', g += '<h3 class="popup-title">Thông báo </h3> <button class="close-popup">x</button>', g += '</div> <div class="popup-content">' + i + "</div> </div> </div>", $("body").append(g), $(".ladi-popup-form").show(), $(".ladi-popup-form").css({position: "fixed"}), $(".ladi-popup-form .popup-dialog").show(), $(".close-popup").click(function () {
...
function endTime(t) {
    ...
    return {t: e, d: Math.floor(e / 864e5), h: o, m: n, s: i}
}
function countDown(t, e) {
    var i = t.find("div > span"), n = i.eq(0), o = i.eq(1), a = i.eq(2), r = i.eq(3);

    function l() {
        var i = endTime(e);
        i.t > 0 ? (n.text(i.d), o.text(i.h), a.text(i.m), r.text(i.s)) : (n.text("00"), o.text("00"), a.text("00"), r.text("00"), clearInterval(s), $(t.attr("lp-show")).addClass("animated fadeInDown").css({display: "block"}))
    }
...
function accountFree() {
    ...
    -1 != t.search("pagedemo.me") ? showWatermark("1") : $.ajax({
        type: "POST",
...
GoogleMap.prototype.init = function () {
    ...
    e.length > 0 && e.each(function () {
        var e = $(this).find(".widget-content").eq(0)[0], i = parseFloat($(this).attr("lp-mapzoom")),
            n = $(this).attr("lp-mapaddress"), o = $(this).attr("lp-maptitletext"),
            a = $(this).attr("lp-maptitleimage");
        void 0 != a && "" != a && (o = '<div class="lp-maptitle"><p><img src="' + a + '"></p><p>' + o + "</p></div>"), t.createMaps(e, i, n, o)
    })
}, GoogleMap.prototype.createMaps = function (t, e, i, n) {
    window.google = window.google || {}, google.maps = google.maps || {}, google && (new google.maps.Geocoder).geocode({address: i}, function (i, o) {
        if (o == google.maps.GeocoderStatus.OK) {
            var a = new google.maps.Map(t, {zoom: e, center: i[0].geometry.location}),
                r = new google.maps.Marker({map: a, position: i[0].geometry.location});
            new google.maps.InfoWindow({content: n}).open(a, r)
        }
    })
};
    ...
    void 0 != t && t.length > 0 && t.unbind("click").click(function () {
        ...
        if (void 0 != t && "undefined" != t && "" != t && $("#" + t).length > 0) {
            ...
            if (void 0 != e && e.length > 0) {
                var i = "", n = ($(window).outerHeight() - 600) / 2, o = 600;
                n < 0 && (n = 0, o = $(window).outerHeight()), i = i + '<div class="lp-popup-pub lightbox-image" style="position: fixed;"><div class="container animated fadeIn" style="display:none;"><div class="closePop" style="top:' + (n - 12) + 'px!important;left: -12px!important; padding:0px; padding-left: 6px;">X</div>' + e[0].outerHTML + "</div></div>", $("body").append(i), $(".lightbox-image #" + t).css({
                    width: "100%",
                    height: o + "px",
                    left: "0px",
                    top: n + "px"
...
var runtrackingCus = function (ele) {
    ...
    1 != e && $(window).outerWidth() < 768 && $(".widget-content").each(function () {
        var t = parseFloat($(this).css("font-size")), i = parseFloat($(this).css("line-height")),
            n = parseFloat(t * e * e).toFixed(4), o = parseFloat(i * e * e).toFixed(4);
        $(this).css("font-size", parseFloat(n)), $(this).css("line-height", parseFloat(o) + "px")
    })
}, LadiApp = function () {
    ...
    if (i && i.length > 0); else {
        ...
        o && o.length > 0 && o.each(function () {
            ...
            if (e && e.length > 0) {
                var i = $(this).offset().top, o = $(this).outerHeight();
                -1 == $.inArray($(this).attr("id"), LP_DOC.arrAnimate) && (i + o < t || i > t + n || ("fixed" != $(this).css("position") && $(this).hasClass("widget-element") && "true" == $(this).attr("lp-popup") || $(this).addClass(e), LP_DOC.arrAnimate.push($(this).attr("id"))))
            }
        }), stickyRun()
    }
}, trackingScroll = [];
LadiApp.prototype.init = function () {
    ...
    $(window).on("mousewheel", function (t) {
        ...
        var o = $('.widget-section[lp-popup="true"]:visible');
        o && o.length > 0 || (runAdimate(), runAnimateSection(), stickyRun()), runAnimateSection();
        var a = Math.round((scrollTop + $(window).outerHeight()) / $("body").outerHeight() * 100);
        a <= 25 && -1 == $.inArray(25, trackingScroll) && (trackingScroll.push(25), scroll25()), a > 25 && a <= 50 && -1 == $.inArray(50, trackingScroll) && (trackingScroll.push(50), scroll50()), a > 50 && a <= 75 && -1 == $.inArray(75, trackingScroll) && (trackingScroll.push(75), scroll75()), a > 75 && a <= 100 && -1 == $.inArray(100, trackingScroll) && (trackingScroll.push(100), scroll100())
    }), (new GoogleMap).init(), (new LightBox).init();
    ...
    o && o.length, o.on("scroll", function (t) {
        ...
        if (n && n.length > 0) {
            ...
            n.each(function () {
                var t = $(this).offset().top;
                t + $(this).offset().height < e || t > e + o || ("true" == $(this).attr("lp-tracking") || $(this).attr("lp-traking-cus") && $(this).attr("lp-traking-cus").length > 0) && -1 == $.inArray($(this).id, trackingScroll) && (runtrackingCus($(this)), trackingScroll.push($(this).attr("id")))
            })
        }
...
var stickyRun = function () {
    var t, e, i, n, o = $('[lp-sticky="1"]'), a = $(window).scrollTop(), r = $(window).outerHeight();
    o && o.length > 0 && o.each(function () {
        i = $(this).attr("lp-style-offset-left") + "px", n = parseFloat($(this).attr("lp-style-offset-top")), t = $(this).attr("lp-sticky-pos"), e = parseFloat($(this).attr("lp-sticky-kc")), a > n || a + r < n ? ($(this).css({
            position: "fixed",
            "z-index": "9999"
    ...
    if ($('.widget-element[lp-type="button"][lp-parent="' + t.attr("id") + '"]').css({"z-index": 2}), t.attr("lp-vt-item") && t.attr("lp-vt-item").length > 0)for (var e = JSON.parse(t.attr("lp-vt-item")), i = 0; i < e.length; i++) {
        ...
        e = [];
        var o = t.find('.widget-element[lp-type="item_form"]');
        if (!(o && o.length > 0))return !0;
        o.each(function () {
            var t = {id: $(this).attr("id"), top: parseFloat($(this).css("top"))};
            e.push(t)
        });
        for (i = 0; i < e.length; i++)for (var a = 0; a < e.length; a++)if (e[a].top > e[i].top) {
            var r = {};
            r.id = e[a].id, r.top = e[a].top, e[a].id = e[i].id, e[a].top = e[i].top, e[i].id = r.id, e[i].top = r.top
        }
    ...
    t && t.length > 0 && t.each(function () {
        ...
        if ($('.widget-element[lp-type="button"][lp-parent="' + $(this).attr("id") + '"]').css({"z-index": 2}), $(this).attr("lp-vt-item") && $(this).attr("lp-vt-item").length > 0)for (var e = JSON.parse($(this).attr("lp-vt-item")), i = 0; i < e.length; i++) {
            ...
            e = [];
            var o = $(this).find('.widget-element[lp-type="item_form"]');
            if (o && o.length > 0 && (o.each(function () {
                    var t = {id: $(this).attr("id"), top: parseFloat($(this).css("top"))};
                    e.push(t)
                }), e && e.length > 0)) {
                for (i = 0; i < e.length; i++)for (var a = 0; a < e.length; a++)if (e[a].top > e[i].top) {
...
function ladinotify() {
    ...
    (t = jQuery).fn.ladiNotify = function (e) {
        var i = t.extend({showDuration: 4e3, hideDuration: 6e3}, e),
            n = "https://static.ladipage.net/source/notify.svg", o = [{key: "gsx$title", className: ".nttitle"}, {
                key: "gsx$content",
                className: ".ntcontent"
            }, {key: "gsx$time", className: ".nttime"}, {key: "gsx$image", className: ".ntimage img"}];
        this.each(function () {
            var e = t(this), a = e.data("notify").sheetid;
            if (void 0 != a && 0 != a.trim().length) {
                ...
                switch (r) {
                    case"topleft":
                        e.css({top: "-100px", left: "0", right: "auto", bottom: "auto"});
                        break;
                    case"topright":
                        e.css({top: "-100px", right: "0", left: "auto", bottom: "auto"});
                        break;
                    case"bottomright":
                        e.css({bottom: "-100px", right: "0", left: "auto", top: "auto"});
                        break;
                    case"bottomleft":
                        e.css({bottom: "-100px", left: "0", right: "auto", top: "auto"});
                        break;
                    default:
                        e.css("position", "absolute")
                }
                var l = i.showDuration + i.hideDuration;
                t.getJSON("https://spreadsheets.google.com/feeds/list/" + a + "/1/public/values?alt=json", function (t) {
                    var e = t.feed.entry;
                    s(e);
                    var i = e.length;
                    setInterval(function () {
            ...
            function s(a) {
                ...
                var s = i.showDuration, c = i.hideDuration + s;
                t(a).each(function () {
                    var t = this;
                    setTimeout(function () {
                        var i = Object.keys(t);
                        switch (o.forEach(function (o) {
                            if (-1 != i.indexOf(o.key))if ("gsx$image" != o.key) e.find(o.className).text(t[o.key].$t); else {
                                var a = t[o.key].$t;
                                Boolean(t[o.key].$t) || (a = n), e.find(o.className).attr("src", a)
                            }
                        }), e.css("opacity", "1"), r) {
                            case"topleft":
                            case"topright":
...
function ladicarousel() {
    var t;
    (t = jQuery).fn.ladiCarousel = function (e) {
        var i = t.extend({autoplay: !1, delay: 5e3}, e);
        this.each(function () {
            var e = t(this), n = e.width(), o = n * (e.find(".widget-item-child").length - 1),
                a = e.find(".wrap-child");
            a.css("left", 0), a.addClass("animatecarousel");
            var r = parseFloat(a.css("left")), l = e.find(".control-slider-right"), s = e.find(".control-slider-left");
            ...
            var p, d, h, u = i.autoplay, g = i.delay;
...
$(document).ready(function () {
    ...
    t && t.length > 0 || $(".widget-section").wrapAll("<div class='ladi-wraper-page'/>"), (new ReponsivePage).init(), showPopupLoadPage(), $(".lp-close-fb-mes").unbind("click").click(function (t) {
        ...
        if (t = $(this).attr("lp-endtime"), "time" == e && "timedown" != e) {
            ...
            if (i && i.length > 0) {
                var n = new Date(t).getTime(), o = (new Date).getTime(), a = Math.ceil((o - n) / 864e5);
                if (a > 0) {
                    var r = Math.ceil(a / parseFloat(i)) * i, l = new Date(t).setDate(new Date(t).getDate() + r);
